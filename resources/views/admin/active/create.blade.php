...
<section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form class="form-horizontal" role="form" method="POST" action="/admin/actives"  enctype="multipart/form-data" >
                    {{ csrf_field() }}
                    <!-- Custom Tabs -->
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="请填写本次活动的名称, 最多10个字">
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <input id="url" type="text" class="form-control" name="url" value="{{ old('url') }}" placeholder="对上述活动名称的合理的翻译即可,多个单词使用 _ 分隔">
                                ...
                                <div class="form-group{{ $errors->has('sort') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <input name="sort" type="number" class="form-control" value="{{ old('sort',100) }}" id="" placeholder="数字越大排名越靠前">
                                        @if ($errors->has('sort'))
                                            <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('is_content') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-2">
                                        <label class="radio-inline">
                                            <input type="radio" name="is_content"  value="1"  {{ old('is_content', 0) == 1?'checked':'' }}> 是
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="is_content"  value="0"  {{ old('is_content', 0) == 0?'checked':'' }}> 否
                                        </label>
                                ...
                                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                                    <label for="image" class="col-md-4 control-label">活动封面 *</label>
                                    <div class="col-md-4">
